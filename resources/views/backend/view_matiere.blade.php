          ...
          <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    {{-- <a href="{{ route('matiere.add') }}" class="btn btn-block bg-gradient-primary offset-md-1 col-md-2 order-md-1 mt-sm-2">إضافة مادة</a> --}}
                                ...
                                <form method="post" action='{{ route('matiere.store') }}' width=60%>
                                    @csrf
                                        ...
                                        <div class="form-group col-md-6">
                                          ...
                                          <div class="form-group col-md-6">
                                            <label for="libelle"> الإسم<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="libelle" name="libelle" placeholder="أدخل الإسم" required>
                                          </div>
                                        </div>
                            </div>
              ...
              <table id="example1" class="table table-bordered table-striped p-3">
                ...
                <tr>
                  ...
                  <td>
                        ...
                        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#model{{$matiere->id}}">
                            تحديث
                          </button>



                        <a href="{{ route("matiere.delete", $matiere->id) }}" class="btn btn-danger" id="delete">حذف</a>
                  </td>
                </tr>
                @endforeach
                </tfoot>
              ...
              <div class="modal fade" id="model{{$matiere->id}}" tabindex="-1"  aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action='{{ route('matiere.miseajour',$matiere->id) }}' width=60%>
                            @csrf

                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="niveau"> المستوى<span class="text-danger">*</span></label>
                                    <input type="number" class="form-control" id="niveau" name="niveau" placeholder="أدخل المستوى" min="1" max="6" required value="{{ $matiere->niveau }}">
                                  </div>
                                  <div class="form-group col-md-6">
                                    <label for="libelle"> الإسم<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="libelle" name="libelle" placeholder="أدخل الإسم" value="{{ $matiere->libelle }}" required>
                                  </div>
                                </div>
                    </div>
                    <div class="modal-footer">
