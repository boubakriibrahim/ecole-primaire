    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 fixed-top">
      <div class="container">
        <a href="{{ url('/') }}" class="navbar-brand navbar-no-expand float-right order-2">
            ...
            <img src="{{asset('images/logo.jpg')}}" alt="Logo" class="brand-image rounded-circle elevation-3" style="opacity: .8" width="35">
          </a>
        ...
        <div class="collapse navbar-collapse float-left order-3 order-lg-1 text-end" id="navmenu">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a href="#learn" class="nav-link">فريق العمل</a>
              </li>
            <li class="nav-item">
              <a href="#questions" class="nav-link">أسئلة</a>
            </li>
            <li class="nav-item">
              <a href="#instructors" class="nav-link">معلومات الاتصال</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <section id="learn" class="p-5">
      <div class="container">
        <div class="row align-items-center justify-content-between">
          <div class="col-md">
            <img src="{{ asset('images/svg/fundamentals.svg') }}" class="img-fluid" alt="" />
          </div>
    ...
    <section id="learn" class="p-5 bg-dark text-light">
      <div class="container">
        <div class="row align-items-center justify-content-between">
          ...
          <div class="col-md">
            <img src="{{ asset('images/svg/react.svg') }}" class="img-fluid" alt="" />
          </div>
        </div>
      </div>
    </section>
