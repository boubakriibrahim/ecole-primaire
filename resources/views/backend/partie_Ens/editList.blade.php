            ...
            <div class="list-group shadow-lg p-3 mb-5 bg-info rounded-pill col-md-8 d-flex justify-content-center ">
                <div class="d-flex justify-content-center  ">
                    <div class="col-md-6 bg-light ">
                        <div class="d-flex justify-content-center  ">
                            <div class="list-group-item list-group-item-action active col-md-5 bg-light rounded-pill float-right mt-2 text-center"
                                aria-current="true">
                                قائمة القسم
                                {{$classe["classe"]['nom']}}
                            </div>
                                ...
                                <div class=" flex-row-reverse">
                                    <div class="list-group-item list-group-item-action rounded-pill " tabindex="-1"
                                        ...
                                        <select class="form-select form-select-sm rounded-pill bg-body w-100"
                                            aria-label=".form-select-sm example" name="noms[]" dir="rtl" required>
                                            <option value="{{$aff->eleve->id}}"> {{$aff->eleve->nom}}
                                                {{$aff->eleve->prenom}}</option>
